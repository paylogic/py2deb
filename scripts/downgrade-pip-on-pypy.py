...
if platform.python_implementation() == "PyPy":
    ...
    if installed_release >= known_bad_release:
        sys.stderr.write("[downgrade-pip-on-pypi] Removing broken pip release ..\n")
        subprocess.check_call([sys.executable, "-m", "pip", "uninstall", "--yes", "pip"])
        sys.stderr.write("[downgrade-pip-on-pypi] Downgrading pip using easy_install ..\n")

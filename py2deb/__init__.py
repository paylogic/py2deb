...
class RedirectOutput:
    ...
    """
    Make sure all output generated by Python libraries (like pip-accel and pip)
    and subprocesses (like `python setup.py ...') is redirected to the standard
    error stream. This way we can be sure that the standard output stream can
    be reliably used for our purposes (specifically: reporting Debian package
    dependencies).
    """

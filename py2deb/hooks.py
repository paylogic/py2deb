...
"""
The :py:mod:`py2deb.hooks` module contains post-installation and pre-removal hooks.
...
The :py:func:`~py2deb.package.PackageToConvert.generate_maintainer_script()`
...
appending a call to :py:func:`post_installation_hook()` or
:py:func:`pre_removal_hook()` at the bottom.
"""
...
def post_installation_hook(package_name, alternatives, modules_directory, namespaces):
    ...
    :param alternatives: The relevant subset of values in
                         :py:attr:`~py2deb.converter.PackageConverter.alternatives`.
    ...
    :param namespaces: The namespaces used by the package (a list of tuples
                       ...
                       :py:attr:`~py2deb.package.PackageToConvert.namespaces`).

    Uses the following functions to implement everything py2deb needs from the
    post-installation maintainer script:

    - :py:func:`generate_bytecode_files()`
    - :py:func:`create_alternatives()`
    - :py:func:`initialize_namespaces()`
    """
    initialize_logging()
...
def pre_removal_hook(package_name, alternatives, modules_directory, namespaces):
    ...
    - :py:func:`cleanup_bytecode_files()`
    - :py:func:`cleanup_alternatives()`
    - :py:func:`cleanup_namespaces()`
    """
    initialize_logging()
    installed_files = find_installed_files(package_name)
...
def generate_bytecode_files(package_name, installed_files):
    ...
    Uses :py:mod:`py_compile.compile()` to generate bytecode files.
...
def cleanup_alternatives(package_name, alternatives):
    """
    Cleanup the alternatives that were previously installed by :py:func:`create_alternatives()`.
...
def cleanup_namespaces(package_name, modules_directory, namespaces):
    """
    Clean up Python namespace packages previously initialized using :py:func:`initialize_namespaces()`.
...
class NameSpaceReferenceCount(dict):
    ...
    def __init__(self, modules_directory):
        """
        Initialize a :py:class:`NameSpaceReferenceCount` object.
